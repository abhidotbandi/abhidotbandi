...
export default function ChapterVpp() {
  ...
  return (
    <SectionShell id="vpp" align="right">
      <p className="text-xs font-semibold uppercase tracking-wide text-livewire">Chapter 4 · Zoom back out</p>
      ...
      <div className="grid grid-cols-2 gap-3">
        <StatCallout value={BASE_POWER.scale.homes} label="homes on Base today" color="#39ff14" />
        <StatCallout value={BASE_POWER.scale.deployPace} label="new capacity / month" color="#39ff14" />
      </div>
