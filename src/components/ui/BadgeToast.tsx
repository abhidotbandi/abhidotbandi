...
export default function BadgeToast() {
  ...
  return (
    <div
      key={lastBadge}
      className="panel pointer-events-none fixed top-16 right-4 z-40 w-72 animate-[badge-in_0.3s_ease-out] rounded-md border border-livewire/40 bg-slate-950/90 p-4 shadow-lg shadow-livewire/10 backdrop-blur-sm sm:right-6"
    >
      <p className="text-[10px] font-semibold uppercase tracking-wide text-livewire">Badge unlocked</p>
