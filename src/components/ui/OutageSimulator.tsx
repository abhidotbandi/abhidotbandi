...
export default function OutageSimulator() {
  ...
  return (
    <div className="panel rounded-md border border-white/10 bg-white/5 p-5 backdrop-blur-sm">
      <p className="text-xs font-semibold uppercase tracking-wide text-livewire">Try it</p>
      ...
      <button
        ...
        className={`mt-4 w-full rounded-md px-4 py-3 text-sm font-semibold transition-colors ${
          outageActive
            ? "bg-rose-500/20 text-rose-200 border border-rose-400/40"
            : "bg-livewire text-slate-950 hover:bg-livewire/80"
        }`}
      >
